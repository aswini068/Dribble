...
<body>
    ...
    <section class="gallery">
        ...
        <div class="card">
            <img src="angrydog.png" alt="Design Sample">
            <h3>Angry Dog</h3>
            <p>Emote Team | 7.2k Views</p>
        </div>
        ...
        <div class="card">
            <img src="whitedog.png" alt="Design Sample">
            <h3>White Dog</h3>
            <p>Emote Team | 7.2k Views</p>
        </div>
        ...
        <div class="card">
            <img src="cat2.png" alt="Design Sample">
            <h3>Cat</h3>
            <p>Emote Team | 7.2k Views</p>
        </div>
        ...
        <div class="card">
            <img src="parrot (2).png" alt="Design Sample">
            <h3>parrot</h3>
            <p>Emote Team | 7.2k Views</p>
        </div>
...
![alt text](<Screenshot 2024-11-19 174656.png>)
![alt text](<Screenshot 2024-11-19 174711.png>)
